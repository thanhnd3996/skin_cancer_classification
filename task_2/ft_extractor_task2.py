...
num_classes = 3
labels = ['malignant', 'cancer_2', 'benign']
trained_task2_model = "../checkpoint/inception_v3_task2.h5"
train_set = "../dataset_2/train_images/"
val_set = "../dataset_2/val_images"
test_set = "../dataset_2/test_images"
