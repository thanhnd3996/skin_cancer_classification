...
# load image
train_generator = train_datagen.flow_from_directory("../dataset_3/train_images/",
                                                    target_size=(299, 299), batch_size=batch_size)

valid_generator = val_datagen.flow_from_directory("../dataset_3/val_images/",
                                                  target_size=(299, 299), batch_size=batch_size)
...
# train model
model.fit_generator(train_generator, steps_per_epoch=988 // batch_size, validation_data=valid_generator,
                    validation_steps=213 // batch_size, epochs=epochs, verbose=1, callbacks=[checkpointer])
